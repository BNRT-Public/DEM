    ...
    !--------------------------------------------------------------------------
    !
    SUBROUTINE PRISMEDITGEOM(POS,ROT,DIST,FAEP,FAECOMP,FAETRAC,ISDM,ISFS)
    IMPLICIT NONE
    !
    ! DATA:  17/10/2022
    ...
    !$OMP PARALLEL DO PRIVATE(I,LOGIC, UU0, UU1) SHARED(XB0,YB0,ZB0,POS,R,DIST,ECOMP,ETRAC,EP,DM,FS)
    DO I=1,NBT
        UU0(:,1)=(/XB0(I),YB0(I),ZB0(I)/)
        UU0 = UU0-POS
        UU1=MATMUL(R,UU0)
