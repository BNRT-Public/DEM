    ...
    ! ARCHIVO CON VALORES EN LOS POLOS
    ! FILE: POLOS_Type_Txx.dat
    IF (OU15.GT.0) CLOSE(15)
    
    ! ARCHIVO CON VALORES DE DELTA DE ENERGIA
    ! FILE: DeltaENCN_Txx.dat
    IF (OU16.GT.0) CLOSE(16)
    
    ! ARCHIVO CON VALORES DE FUERZA
    ! FILE: FORCE_Txx.dat
    IF (OU17.GT.0) CLOSE(17)
    
    ! ARCHIVO CON VALORES DE DESPLAZAMIENTO
    ! FILE: BOUND_Txx.dat
    IF (OU18.GT.0) CLOSE(18)
